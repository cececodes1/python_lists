...
# who have submitted their assignments, and the other list contains the names of students who attended the last class.
...
if "Alice" in submitted and "Alice" in attended:
    print("Alice submitted her assignment and attended the last class")
else:
    print("Alice did not submit her assignment or attended the last class")